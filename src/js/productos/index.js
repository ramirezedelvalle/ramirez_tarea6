...
const guardar = async (evento) => {
    ...
    const url = '/ramirez_tarea6/controladores/productos/index.php';
    const config = {
        method : 'POST',
        // body: otroNombre
        body
...
const buscar = async () => {
    ...
    const url = `/ramirez_tarea6/controladores/productos/index.php?producto_nombre=${producto_nombre}&producto_precio=${producto_precio}`;
    const config = {
        method : 'GET'
    }
